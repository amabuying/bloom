...
def validate_payment(request):
    ...
    if not res:
        ...
        from_email = 'salesreportdynarielinnovations@gmail.com'
        to = ['salesreportdynarielinnovations@gmail.com', order.email]
...
def create_checkout_session(request):
    ...
    if gateway == 'stripe':
        session = stripe.checkout.Session.create(
            ...
            line_items=items,
            mode='payment',
            success_url='http://134.209.71.242:8001/cart/success/',
            cancel_url='http://134.209.71.242:8001/cart/'
        )
    ...
    orderid = checkout(request, first_name, last_name, email, address, zipcode, state, phone)
...
def api_checkout(request):
    ...
    orderid = checkout(request, first_name, last_name, email, address, zipcode, state)
